...
Fast Reply | Bold Text | Popup | Video | Link
"""
...
# ═══════════════ BOT ═══════════════
app = Client("final_fixed_bot", api_id=API_ID, api_hash=API_HASH, bot_token=BOT_TOKEN)
...
async def callbacks(client, cb: CallbackQuery):
    ...
    if data == "sep": await cb.answer(); return
